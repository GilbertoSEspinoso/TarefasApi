...
namespace TarefasApi.Endpoints
{
    public static class TarefasEndpoints
    {
        public static void MapTarefasEndpoints(this WebApplication app)
        {
            ...
            app.MapGet("/tarefas", async (GetConection connectionGetter) =>
            {
            ...
            app.MapGet("/tarefas/{id}", async (GetConection connectionGetter, int id) =>
            {
                using var con = await connectionGetter();
            ...
            app.MapPost("/tarefas", async (GetConection connectionGetter, Tarefa tarefa) =>
            {
                using var con = await connectionGetter();
            ...
            app.MapPut("/tarefas", async (GetConection connectionGetter, Tarefa tarefa) =>
            {
                using var con = await connectionGetter();
            ...
            app.MapDelete("/tarefas/{id}", async (GetConection connectionGetter, int id) =>
            {
                using var con = await connectionGetter();
